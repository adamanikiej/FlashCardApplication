...
public class NewSetController implements Initializable {
	...
	@FXML private TableView<Set> tableView;
	@FXML private TableColumn<Set, String> setNameColumn;
	@FXML private TableColumn<Set, Integer> cardCountColumn;
	@FXML private TableColumn<Set, String> creationDateColumn;
	@FXML private TableColumn<Set, String> relatedQuizzesColumn;
